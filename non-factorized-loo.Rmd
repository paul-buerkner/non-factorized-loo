...
$$
where $I$ is the identity matrix of appropriate dimension. Their results readily generalize to an arbitrary nondegenerate covariance matrix $C$ (i.e. it has to be invertible). The LOO predictive mean and standard deviation can be computed as follows:
\begin{align}
